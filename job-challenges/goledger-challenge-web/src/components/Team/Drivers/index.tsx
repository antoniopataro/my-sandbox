  ...
  return (
    <DriverStyles>
      {filteredDrivers.length === 0 ? (
        <h2>
          <span style={{ fontSize: "20px" }}>👲</span> There are no drivers in this team.
        </h2>
      ) : (
        <h2>
          <span style={{ fontSize: "20px" }}>👲</span> Drivers:{" "}
        </h2>
      )}
      <ul>
